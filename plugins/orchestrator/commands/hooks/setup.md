...
```bash
# Test pre-edit hook
orchestrator hook pre-edit --file test.js

# Test session summary
orchestrator hook session-end --summary
```
    ...
    "PreToolUse": [
      {
        ...
        "hooks": [{
          "type": "command",
          "command": "orchestrator hook pre-write --file '${tool.params.file_path}'"
        }]
      }
    ]
  }
...
# Test specific hook
orchestrator hook pre-edit --file app.js --debug
```
...
```json
{
  ...
  "hooks": [{
    "type": "command",
    "command": "orchestrator hook check-protected --file '${tool.params.file_path}'"
  }]
}
```
