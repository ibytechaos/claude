...
```bash
orchestrator verify check [options]
```
...
orchestrator verify check --file src/critical.js --threshold 0.99

# Verify and auto-fix issues
orchestrator verify check --directory src/ --auto-fix

# Get JSON output for CI/CD
orchestrator verify check --json > verification.json
```
