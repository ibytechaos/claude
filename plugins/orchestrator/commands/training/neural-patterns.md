...
```
Tool: mcp__orchestrator__neural_status
Result: {
  "patterns": {
    "convergent": 0.92,
    "divergent": 0.87,
...
## Pattern Analysis
```
Tool: mcp__orchestrator__neural_patterns
Parameters: {
  "action": "analyze",
...
orchestrator neural train --type coordination --epochs 50

# Check neural status
orchestrator neural status

# Analyze patterns
orchestrator neural patterns --analyze
```