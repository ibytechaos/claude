...
### Usage
```bash
orchestrator pair --start --mode driver
```
...
### Usage
```bash
orchestrator pair --start --mode navigator
```
...
### Usage
```bash
orchestrator pair --start --mode switch [--interval <time>]
```
...
```bash
# 5-minute intervals
orchestrator pair --start --mode switch --interval 5m

# 15-minute intervals
orchestrator pair --start --mode switch --interval 15m

# Hour-long intervals
orchestrator pair --start --mode switch --interval 1h
```
