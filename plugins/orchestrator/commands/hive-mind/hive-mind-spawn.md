...
## Usage
```bash
orchestrator hive-mind spawn <objective> [options]
```
...
## Examples
```bash
orchestrator hive-mind spawn "Build API"
orchestrator hive-mind spawn "Research patterns" --queen-type adaptive
orchestrator hive-mind spawn "Build service" --claude
```
