...
mcp__orchestrator__swarm_init { topology: "hierarchical", maxAgents: 6 }
mcp__orchestrator__agent_spawn { type: "coordinator", name: "Release Coordinator" }
mcp__orchestrator__agent_spawn { type: "tester", name: "QA Engineer" }
mcp__orchestrator__agent_spawn { type: "reviewer", name: "Release Reviewer" }
mcp__orchestrator__agent_spawn { type: "coder", name: "Version Manager" }
mcp__orchestrator__agent_spawn { type: "analyst", name: "Deployment Analyst" }
...
[Single Message - Complete Release Management]:
  ...
  mcp__orchestrator__swarm_init { topology: "star", maxAgents: 8 }
  mcp__orchestrator__agent_spawn { type: "coordinator", name: "Release Director" }
  mcp__orchestrator__agent_spawn { type: "tester", name: "QA Lead" }
  mcp__orchestrator__agent_spawn { type: "reviewer", name: "Senior Reviewer" }
  mcp__orchestrator__agent_spawn { type: "coder", name: "Version Controller" }
  mcp__orchestrator__agent_spawn { type: "analyst", name: "Performance Analyst" }
  mcp__orchestrator__agent_spawn { type: "researcher", name: "Compatibility Checker" }
  ...
  mcp__orchestrator__memory_usage {
    ...
    value: {
      ...
      packages: ["orchestrator", "ruv-swarm"],
  ...
  release-validation:
    ...
    steps:
      ...
      - name: Validate Release
        run: orchestrator release validate
```
