...
```bash
orchestrator stream-chain pipeline <type> [options]
```
...
```bash
orchestrator stream-chain pipeline analysis
```
...
```bash
orchestrator stream-chain pipeline refactor
```
...
```bash
orchestrator stream-chain pipeline test
```
...
```bash
orchestrator stream-chain pipeline optimize
```
...
```bash
orchestrator stream-chain pipeline refactor --timeout 60
```

### Verbose Test Generation
```bash
orchestrator stream-chain pipeline test --verbose
```

### Performance Optimization
```bash
orchestrator stream-chain pipeline optimize --debug
```
...
Define custom pipelines in `.orchestrator/config.json`:
...
Then run:
```bash
orchestrator stream-chain pipeline security
```