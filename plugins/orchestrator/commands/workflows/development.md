...
```
Tool: mcp__orchestrator__swarm_init
...
```
Tool: mcp__orchestrator__agent_spawn
Parameters: {
  "type": "architect",
  "name": "System Design",
...
```
Tool: mcp__orchestrator__task_orchestrate
Parameters: {
...
### 4. Monitor Progress
```
Tool: mcp__orchestrator__task_status
...
orchestrator workflow dev "REST API with auth"

# Create custom workflow
orchestrator workflow create --name "api-dev" --steps "design,implement,test,deploy"

# Execute saved workflow
orchestrator workflow execute api-dev
```