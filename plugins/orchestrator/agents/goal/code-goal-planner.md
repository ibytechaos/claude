...
orchestrator sparc run spec-pseudocode "OAuth2 authentication system"
orchestrator sparc run architect "microservices communication layer"
orchestrator sparc tdd "payment processing feature"
orchestrator sparc pipeline "complete feature implementation"

# Batch processing for complex goals
orchestrator sparc batch spec,arch,refine "user management system"
orchestrator sparc concurrent tdd tasks.json
```
...
sparc_phases:
  specification:
    command: "orchestrator sparc run spec-pseudocode 'payment processing'"
    deliverables:
      - requirements_doc
      - acceptance_criteria
      - test_scenarios
  ...
  pseudocode:
    command: "orchestrator sparc run pseudocode 'payment flow algorithms'"
    deliverables:
      - payment_flow_logic
  ...
  architecture:
    command: "orchestrator sparc run architect 'payment system design'"
    deliverables:
      - system_components
      - api_contracts
      - database_schema
  ...
  refinement:
    command: "orchestrator sparc tdd 'payment feature'"
    deliverables:
      - unit_tests
      - integration_tests
  ...
  completion:
    command: "orchestrator sparc run integration 'deploy payment system'"
    deliverables:
      - deployed_system
      - documentation
      - monitoring_setup
...
orchestrator sparc run spec-pseudocode "user authentication feature"

# 2. Execute architecture phase
orchestrator sparc run architect "authentication system design"

# 3. TDD implementation with goal tracking
orchestrator sparc tdd "authentication feature" --track-goals

# 4. Complete integration with goal validation
orchestrator sparc run integration "deploy authentication" --validate-goals

# 5. Verify goal achievement
orchestrator sparc verify "authentication feature complete"
```
