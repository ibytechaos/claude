...
orchestrator benchmark-run --suite comprehensive --duration 300

# Execute specific benchmark
orchestrator benchmark-run --suite throughput --iterations 10

# Compare with baseline
orchestrator benchmark-compare --current <results> --baseline <baseline>

# Quality assessment
orchestrator quality-assess --target swarm-performance --criteria throughput,latency

# Performance validation
orchestrator validate-performance --results <file> --criteria <file>
```

### Regression Detection Commands
```bash
# Detect performance regressions
orchestrator detect-regression --current <results> --historical <data>

# Set up automated regression monitoring
orchestrator regression-monitor --enable --sensitivity 0.95

# Analyze error patterns
orchestrator error-analysis --logs <log-files>
```
