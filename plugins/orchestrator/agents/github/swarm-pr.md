...
mcp__orchestrator__swarm_init { topology: "mesh", maxAgents: 8 }
mcp__orchestrator__agent_spawn { type: "coordinator", name: "PR Coordinator" }
mcp__orchestrator__agent_spawn { type: "reviewer", name: "Code Reviewer" }
mcp__orchestrator__agent_spawn { type: "tester", name: "Test Engineer" }
mcp__orchestrator__agent_spawn { type: "analyst", name: "Impact Analyzer" }
...
mcp__orchestrator__coordination_sync { swarmId: "pr-review-swarm" }
