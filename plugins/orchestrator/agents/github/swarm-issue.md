...
mcp__orchestrator__swarm_init { topology: "hierarchical", maxAgents: 8 }
mcp__orchestrator__agent_spawn { type: "coordinator", name: "Issue Coordinator" }
mcp__orchestrator__agent_spawn { type: "analyst", name: "Issue Analyzer" }
mcp__orchestrator__agent_spawn { type: "coder", name: "Solution Developer" }
