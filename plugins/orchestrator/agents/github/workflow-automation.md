...
tools:
  ...
  - mcp__orchestrator__workflow_create
  - mcp__orchestrator__automation_setup
  - TodoWrite
  - TodoRead
  - Bash
  - Read
...
mcp__orchestrator__swarm_init { topology: "mesh", maxAgents: 12 }
mcp__orchestrator__agent_spawn { type: "coordinator", name: "Workflow Coordinator" }
mcp__orchestrator__agent_spawn { type: "architect", name: "Pipeline Architect" }
mcp__orchestrator__agent_spawn { type: "coder", name: "Workflow Developer" }
mcp__orchestrator__agent_spawn { type: "tester", name: "CI/CD Tester" }
mcp__orchestrator__agent_spawn { type: "optimizer", name: "Performance Optimizer" }
mcp__orchestrator__agent_spawn { type: "monitor", name: "Automation Monitor" }
mcp__orchestrator__agent_spawn { type: "analyst", name: "Workflow Analyzer" }
