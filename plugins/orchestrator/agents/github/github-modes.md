...
tools: mcp__orchestrator__swarm_init, mcp__orchestrator__agent_spawn, mcp__orchestrator__task_orchestrate, Bash, TodoWrite, Read, Write
color: purple
type: development
capabilities:
...
mcp__orchestrator__agent_spawn { type: "coordinator", name: "GitHub Coordinator" }
mcp__orchestrator__agent_spawn { type: "reviewer", name: "Code Reviewer" }
mcp__orchestrator__agent_spawn { type: "tester", name: "QA Agent" }

// Execute GitHub workflow with coordination
mcp__orchestrator__task_orchestrate { task: "GitHub workflow", strategy: "parallel" }
```