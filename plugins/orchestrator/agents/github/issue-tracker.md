...
tools: mcp__orchestrator__swarm_init, mcp__orchestrator__agent_spawn, mcp__orchestrator__task_orchestrate, mcp__orchestrator__memory_usage, Bash, TodoWrite, Read, Write
color: green
type: development
capabilities:
...
mcp__orchestrator__swarm_init { topology: "star", maxAgents: 3 }
mcp__orchestrator__agent_spawn { type: "coordinator", name: "Issue Coordinator" }
mcp__orchestrator__agent_spawn { type: "researcher", name: "Requirements Analyst" }
mcp__orchestrator__agent_spawn { type: "coder", name: "Implementation Planner" }
...
[Single Message - Issue Lifecycle Management]:
  ...
  mcp__orchestrator__agent_spawn { type: "coordinator", name: "Issue Manager" }
  mcp__orchestrator__agent_spawn { type: "analyst", name: "Progress Tracker" }
  mcp__orchestrator__agent_spawn { type: "researcher", name: "Context Gatherer" }
