...
tools:
  ...
  - mcp__orchestrator__github_pr_manage
  - mcp__orchestrator__github_code_review
  - mcp__orchestrator__github_metrics
hooks:
  pre:
...
mcp__orchestrator__agent_spawn { type: "reviewer", name: "Code Quality Reviewer" }
mcp__orchestrator__agent_spawn { type: "tester", name: "Testing Agent" }
mcp__orchestrator__agent_spawn { type: "coordinator", name: "PR Coordinator" }
...
[Single Message - Complete PR Management]:
  ...
  mcp__orchestrator__agent_spawn { type: "coordinator", name: "Merge Coordinator" }
