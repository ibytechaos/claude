...
tools:
  ...
  - mcp__orchestrator__coordination_sync
...
- `mcp__github__create_pull_request`
- `mcp__github__search_repositories`
- `mcp__orchestrator__*` (all swarm coordination tools)
...
mcp__orchestrator__swarm_init { topology: "hierarchical", maxAgents: 5 }
mcp__orchestrator__agent_spawn { type: "coordinator", name: "Sync Coordinator" }
mcp__orchestrator__agent_spawn { type: "analyst", name: "Dependency Analyzer" }
mcp__orchestrator__agent_spawn { type: "coder", name: "Integration Developer" }
mcp__orchestrator__agent_spawn { type: "tester", name: "Validation Engineer" }
...
[Single Message - Complete Synchronization]:
  ...
  mcp__orchestrator__swarm_init { topology: "mesh", maxAgents: 6 }
  mcp__orchestrator__agent_spawn { type: "coordinator", name: "Master Sync Coordinator" }
  mcp__orchestrator__agent_spawn { type: "analyst", name: "Package Analyzer" }
  mcp__orchestrator__agent_spawn { type: "coder", name: "Integration Coder" }
  mcp__orchestrator__agent_spawn { type: "tester", name: "Validation Tester" }
  mcp__orchestrator__agent_spawn { type: "reviewer", name: "Quality Reviewer" }
...
mcp__orchestrator__swarm_init { topology: "hierarchical", maxAgents: 10 }
mcp__orchestrator__agent_spawn { type: "coordinator", name: "Master Sync Coordinator" }
mcp__orchestrator__agent_spawn { type: "analyst", name: "Dependency Analyzer" }
mcp__orchestrator__agent_spawn { type: "coder", name: "Integration Developer" }
mcp__orchestrator__agent_spawn { type: "tester", name: "Validation Engineer" }
mcp__orchestrator__agent_spawn { type: "reviewer", name: "Quality Assurance" }
mcp__orchestrator__agent_spawn { type: "monitor", name: "Sync Monitor" }
...
mcp__orchestrator__swarm_init { topology: "star", maxAgents: 5 }
mcp__orchestrator__agent_spawn { type: "monitor", name: "Error Monitor" }
mcp__orchestrator__agent_spawn { type: "analyst", name: "Failure Analyzer" }
mcp__orchestrator__agent_spawn { type: "coder", name: "Recovery Developer" }

# Coordinate recovery procedures
mcp__orchestrator__coordination_sync { swarmId: "error-recovery-swarm" }
