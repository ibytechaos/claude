...
**Usage:**
```bash
orchestrator init --agent reasoning
...
```bash
# Via orchestrator (when integrated)
orchestrator agent run goal-planner "Complex deployment task"
...
- GitHub: https://github.com/ruvnet/orchestrator/issues
- Documentation: https://github.com/ruvnet/orchestrator
