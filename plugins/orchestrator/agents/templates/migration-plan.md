...
tools:
  allowed:
    ...
    - mcp__orchestrator__daa_agent_create
    - mcp__orchestrator__agent_list
    - mcp__orchestrator__memory_usage
  restricted:
    - Bash
    - Write
...
tools:
  allowed:
    ...
    - mcp__orchestrator__parallel_execute
    - TodoWrite
    - TodoRead
  restricted:
    - Bash
...
tools:
  allowed:
    ...
    - mcp__orchestrator__swarm_init
    - mcp__orchestrator__agent_spawn
    - mcp__orchestrator__github_code_review
    - mcp__orchestrator__memory_usage
  restricted:
    - Write
    - Edit
...
tools:
  allowed:
    - Bash
    - Read
    - mcp__orchestrator__github_release_coord
    - mcp__orchestrator__swarm_init
    - mcp__orchestrator__task_orchestrate
    - TodoWrite
  restricted:
...
tools:
  allowed:
    ...
    - TodoWrite
  restricted:
    - mcp__orchestrator__swarm_init  # Focus on implementation
triggers:
...
tools:
  allowed:
    ...
    - mcp__orchestrator__metrics_collect
...
tools:
  allowed:
    - mcp__orchestrator__token_usage
    - mcp__orchestrator__cost_analysis
    - mcp__orchestrator__usage_stats
    - mcp__orchestrator__memory_analytics
    - Read
  restricted:
    - Write
    - Edit
...
tools:
  allowed:
    - mcp__orchestrator__memory_usage
    - mcp__orchestrator__memory_search
    - mcp__orchestrator__memory_namespace
    - mcp__orchestrator__memory_compress
    - mcp__orchestrator__memory_sync
  restricted:
    - Write
    - Edit
    - Bash
...
tools:
  allowed:
    - mcp__orchestrator__neural_train
    - mcp__orchestrator__neural_patterns
    - mcp__orchestrator__neural_predict
    - mcp__orchestrator__cognitive_analyze
    - mcp__orchestrator__learning_adapt
  restricted:
    - Write
    - Edit
    - Bash
...
tools:
  allowed:
    - mcp__orchestrator__daa_agent_create
    - mcp__orchestrator__daa_capability_match
    - mcp__orchestrator__daa_resource_alloc
    - mcp__orchestrator__swarm_scale
    - mcp__orchestrator__agent_metrics
  restricted:
    - Write
    - Edit
    - Bash
...
tools:
  allowed:
    ...
    - mcp__orchestrator__error_analysis
    - mcp__orchestrator__diagnostic_run
...
tools:
  allowed:
    ...
    - mcp__orchestrator__batch_process
    - mcp__orchestrator__performance_report
    - TodoWrite
  restricted:
    - Write
...
tools:
  allowed:
    ...
    - mcp__orchestrator__swarm_status
    - mcp__orchestrator__metrics_collect
  restricted:
    - Write
    - Edit
