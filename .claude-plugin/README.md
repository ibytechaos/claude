...
[![Version](https://img.shields.io/badge/version-2.5.0-blue.svg)](https://github.com/ibytechaos/claude)
...
```bash
git clone https://github.com/ibytechaos/claude.git
cd claude-flow
```
...
- **Documentation**: [GitHub Wiki](https://github.com/ibytechaos/claude/wiki)
- **Issues**: [GitHub Issues](https://github.com/ibytechaos/claude/issues)
- **Discussions**: [GitHub Discussions](https://github.com/ibytechaos/claude/discussions)
